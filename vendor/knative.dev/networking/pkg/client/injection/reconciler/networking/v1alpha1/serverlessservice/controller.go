...
import (
	...
	versionedscheme "knative.dev/networking/pkg/client/clientset/versioned/scheme"
	client "knative.dev/networking/pkg/client/injection/client"
	serverlessservice "knative.dev/networking/pkg/client/injection/informers/networking/v1alpha1/serverlessservice"
...
const (
	...
	defaultFinalizerName       = "serverlessservices.networking.internal.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.ImplStd {
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "networking.internal.knative.dev.ServerlessService"),
	)
